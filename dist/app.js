    ...
    function fastparallel(options) {
      ...
      function goResultsArray(that, funcs, arg, holder) {
        ...
        for (var i = 0; i < funcs.length; i++) {
          ...
          if (that) {
            if (tc.length === 1)
              tc.call(that, sc.release);
            else
              tc.call(that, arg, sc.release);
          } else {
            if (tc.length === 1)
              tc(sc.release);
            else
...
var require_depd = __commonJS({
  "node_modules/http-errors/node_modules/depd/index.js"(exports2, module2) {
    "use strict";
...
// node_modules/fastify-jwt-deprecated/jwt.js
var require_jwt = __commonJS({
  "node_modules/fastify-jwt-deprecated/jwt.js"(exports2, module2) {
    "use strict";
    ...
    function fastifyJwt(fastify2, options, next) {
      if (!options.secret) {
      ...
      const namespace = typeof options.namespace === "string" ? options.namespace : void 0;
      if (signOptions && signOptions.algorithm && signOptions.algorithm.includes("RS") && (typeof secret === "string" || secret instanceof Buffer)) {
      ...
      if (signOptions && signOptions.algorithm && signOptions.algorithm.includes("ES") && (typeof secret === "string" || secret instanceof Buffer)) {
      ...
      if (namespace) {
        ...
        fastify2.jwt[namespace] = jwtConfig;
        ...
        fastify2.decorateRequest("user", null);
        fastify2.decorate("jwt", jwtConfig);
      }
      ...
      function decode(token, options2) {
        ...
        if (options2 && typeof options2 !== "function") {
          const localDecoder = createDecoder(options2);
      ...
      function checkAndMergeOptions(options2, defaultOptions, usePrivateKey, callback) {
        ...
        if (typeof options2 === "function") {
          ...
          if (!options2) {
            ...
            mergedOptions = mergeOptionsWithKey(options2, usePrivateKey);
          }
        }
      ...
      function sign(payload, options2, callback) {
        ...
        convertTemporalProps(options2);
        const signerConfig2 = checkAndMergeSignOptions(options2, callback);
        if (options2 && typeof options2 !== "function") {
      ...
      function verify(token, options2, callback) {
        ...
        convertTemporalProps(options2, true);
        const veriferConfig = checkAndMergeVerifyOptions(options2, callback);
        if (options2 && typeof options2 !== "function") {
      ...
      function replySign(payload, options2, next2) {
        ...
        if (options2.sign) {
          convertTemporalProps(options2.sign);
          options2 = {
            sign: mergeOptionsWithKey({ ...signOptions, ...options2.sign }, true)
          };
        } else {
          convertTemporalProps(options2);
          options2 = mergeOptionsWithKey({ ...signOptions, ...options2 }, true);
        }
        if (!payload) {
      ...
      function requestVerify(options2, next2) {
        ...
        if (options2.decode || options2.verify) {
          convertTemporalProps(options2.verify, true);
          options2 = {
            decode: Object.assign({}, decodeOptions, options2.decode),
            verify: Object.assign({}, verifyOptions, options2.verify)
          };
          ...
          function checkIfIsTrusted(result, callback) {
            if (!trusted) {
              ...
              if (maybePromise && maybePromise.then) {
                maybePromise.then((trusted2) => trusted2 ? callback(null, result) : callback(new Unauthorized(messagesOptions.authorizationTokenUntrusted)));
...
var import_fastify_jwt_deprecated = __toESM(require_jwt());
...
async function partnerRoutes(server2) {
  server2.post(
    "/",
    {
      schema: {
...
async function storeCategoryRoutes(server2) {
  server2.get(
    "/mock",
    // {
    //   schema: {
...
async function storeStatusRoutes(server2) {
  server2.get(
    "/mock",
    // {
    //   schema: {
...
async function userRoleRoutes(server2) {
  server2.get(
    "/mock",
    // {
    //   schema: {
...
server.register(import_fastify_jwt_deprecated.default, {
  secret: API_SECRET
});
...
async function main() {
  ...
  try {
    ...
    console.log(`\u{1F680} Server on \u{1F680} http://${API_HOST}:${API_PORT}`);
  } catch (err) {
    console.log(err);
    process.exit(1);
  }
