...
// src/schemas/storeStatus/create.storeStatus.schema.ts
var create_storeStatus_schema_exports = {};
__export(create_storeStatus_schema_exports, {
  createStoreStatusRequest: () => createStoreStatusRequest,
  createStoreStatusRequestSchema: () => createStoreStatusRequestSchema,
  createStoreStatusResponseSchema: () => createStoreStatusResponseSchema
});
module.exports = __toCommonJS(create_storeStatus_schema_exports);
...
// src/schemas/storeStatus/create.storeStatus.schema.ts
var createStoreStatusRequest = {
  name: (0, import_zod3.string)({
    required_error: "O campo 'Nome' e obrigtorio.",
    invalid_type_error: "Nome precisa ser um texto."
  })
};
var createStoreStatusRequestSchema = (0, import_zod3.object)({
  ...createStoreStatusRequest
});
var createStoreStatusResponseSchema = (0, import_zod3.object)({
  ...baseSchema,
  ...createStoreStatusRequest
});
