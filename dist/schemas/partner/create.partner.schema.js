...
var create_partner_schema_exports = {};
__export(create_partner_schema_exports, {
  createPartnerRequest: () => createPartnerRequest,
  createPartnerRequestSchema: () => createPartnerRequestSchema,
  createPartnerResponseSchema: () => createPartnerResponseSchema
});
module.exports = __toCommonJS(create_partner_schema_exports);
