...
var create_userRole_schema_exports = {};
__export(create_userRole_schema_exports, {
  createUserRoleRequest: () => createUserRoleRequest,
  createUserRoleRequestSchema: () => createUserRoleRequestSchema,
  createUserRoleResponseSchema: () => createUserRoleResponseSchema
});
module.exports = __toCommonJS(create_userRole_schema_exports);
